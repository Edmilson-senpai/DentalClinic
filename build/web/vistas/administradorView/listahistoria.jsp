<%-- 
    Document   : listahistoria
    Created on : 2/10/2022, 1:23:19 a. m.
    Author     : reygr
--%>
...
<head>
        ...
        <title>Lista de Historias Médicas</title>
        <%
    ...
    <main class="full-box main-container">
        ...
        <section class="full-box page-content">
            ...
            <div class="full-box page-header">
                <h3 class="text-left">
                    <i class="fa-solid fa-book-medical"></i> &nbsp; LISTA DE HISTORIAS
                </h3>
            ...
            <div class="container-fluid">
                <ul class="full-box list-unstyled page-nav-tabs">
                    ...
                    <li>
                        <a class="active" href="./listahistoria.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE HISTORIAS</a>
                    </li>
                    <li>
                        <a href="./busquedahistoria.jsp"><i class="fas fa-search fa-fw"></i> &nbsp; BUSCAR HISTORIAS</a>
                    </li>
                </ul>
            </div>
