<%-- 
    ...
    Created on : 23/09/2022, 9:33:24 p. m.
    Author     : reygr
--%>
		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<ul class="full-box list-unstyled page-nav-tabs">
					<li>
						<a class="active" href="./nuevocliente.jsp"><i class="fas fa-plus fa-fw"></i> &nbsp; AGREGAR CLIENTE</a>
					</li>
					<li>
						<a href="./listacliente.jsp"><i class="fas fa-clipboard-list fa-fw"></i> &nbsp; LISTA DE CLIENTES</a>
					</li>
			...
			<!-- Content here-->
			<div class="container-fluid">
				<form action="/DentoSmile/GuardarRegistroClienteController" class="form-neon" autocomplete="off" id="formularioNuevoCliente" method="post">
					<fieldset>
								...
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="cliente_dni" class="bmd-label-floating">DNI</label>
                                                                                <input type="text" pattern="[a-zA-Z0-9-]{1,27}" class="form-control" id="cliente_dni" name="cliente_dni" maxlength="27" onkeyup="datosIncompletos()">
									</div>
								</div>
								<div class="col-12 col-md-6">
									<div class="form-group">
										<label for="cliente_nombre" class="bmd-label-floating">Nombre</label>
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="cliente_nombre" id="cliente_nombre" maxlength="40" onkeyup="datosIncompletos()">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="cliente_apellido" class="bmd-label-floating">Apellido</label>
										<input type="text" pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{1,40}" class="form-control" name="cliente_apellido" id="cliente_apellido" maxlength="40" onkeyup="datosIncompletos()">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="cliente_telefono" class="bmd-label-floating">Teléfono</label>
										<input type="text" pattern="[0-9()+]{1,20}" class="form-control" name="cliente_telefono" id="cliente_telefono" maxlength="20" onkeyup="datosIncompletos()">
									</div>
								</div>
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="cliente_correo" class="bmd-label-floating">Correo</label>
										<input type="email" multiple class="form-control" name="cliente_correo" id="cliente_correo" maxlength="40" onkeyup="datosIncompletos()">
									</div>
								</div>                                                            
								<div class="col-12 col-md-4">
									<div class="form-group">
										<label for="cliente_direccion" class="bmd-label-floating">Dirección</label>
										<input type="text" pattern="[a-zA-Z0-9áéíóúÁÉÍÓÚñÑ#- ]{1,150}" class="form-control" name="cliente_direccion" id="cliente_direccion" maxlength="150" onkeyup="datosIncompletos()">
									</div>
								</div>
                                                            
                                                            <label class="col-12 col-md-6" id="avisoDatosIncompletos"> </label>
							</div>
						</div>
					</fieldset>
					<br><br><br>
